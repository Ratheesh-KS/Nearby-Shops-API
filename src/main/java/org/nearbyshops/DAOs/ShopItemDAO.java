...
public class ShopItemDAO {
	...
	public int insertShopItem(ShopItem shopItem)
	{
		...
		String insertShopItemNew = "INSERT INTO "
				+ ShopItem.TABLE_NAME
				+ "("
				+ ShopItem.SHOP_ID + ","
				+ ShopItem.ITEM_PRICE + ","
		...
		try {
			...
			statement = connection.prepareStatement(insertShopItemNew,Statement.RETURN_GENERATED_KEYS);
...
//			statement.setObject(2,shopItem.getItemPrice());
			...
			statement.setObject(6,shopItem.getItemID());
